...
public class ZooGameController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        currentRoundData = dataController.GetCurrentRoundData("Zoo");
        ...
        this.beepAudio = this.gameObject.AddComponent<AudioSource>();
        this.beepAudio.clip = this.beepSound;
        this.beepAudio.loop = false;
            ...
            if ((Input.GetButton("Fire1")))
            {
                ...
                if (hit.distance <= dist)
                {
                    ...
                    if (hit.collider != null)
                    {
                        ...
                        paused = GameObject.Find("Main Camera").GetComponent<ZooPauseMenu>().isPaused;
    ...
    void ShowPanel()
    {
        ...
        if (isRoundActive == false)
        {
            ...
            finishedPanel.transform.position = GameObject.Find("Main Camera").transform.position + forward * 3;
